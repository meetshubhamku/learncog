      ...
      <div class="col-sm-4 my-2 ">
        <div class="card bg-blue text-white">
          <div class="card-body">
            ...
            <a href="./manageCourseCategory.php" class="btn bg-red text-white">Manage</a>
          </div>
        </div>
      </div>
      <!-- Video Course -->
      <div class="col-sm-4 my-2">
        <div class="card bg-blue text-white">
          <div class="card-body">
            ...
            Video Courses</h5>
            <p class="card-text">Lorem ipsum dolor sit amet consectetur adipisicing elit. Aliquam, vero.</p>
            <a href="./manageVideoCourses.php" class="btn bg-red text-white">Manage</a>
          </div>
        </div>
      </div>
      <!-- PHP playground -->
      <div class="col-sm-4 my-2">
        <div class="card bg-blue text-white">
          <div class="card-body">
            ...
            PHP Playground</h5>
            <p class="card-text">Lorem ipsum dolor sit amet consectetur adipisicing elit. Aliquam, vero.</p>
            <a href="./phpPlayground.php" target="_blank" class="btn bg-red text-white">Manage</a>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="row">
      ...
      <div class="col-sm-4 my-2">
        <div class="card bg-blue text-white">
          <div class="card-body">
            ...
            User Management</h5>
            <p class="card-text">Lorem ipsum dolor sit amet consectetur adipisicing elit. Aliquam, vero.</p>
            <a href="./manageUser.php" class="btn bg-red text-white">Manage</a>
          </div>
        </div>
      </div>
      <!-- Notes Tutorials -->
      <div class="col-sm-4 my-2">
        <div class="card bg-blue text-white">
          <div class="card-body">
            ...
            Notes Management</h5>
            <p class="card-text">Lorem ipsum dolor sit amet consectetur adipisicing elit. Aliquam, vero.</p>
            <a href="./manageNotes.php" class="btn bg-red text-white">Manage</a>
          </div>
        </div>
      </div>
      <!-- Video Course -->
      <div class="col-sm-4 my-2">
        <div class="card bg-blue text-white">
          <div class="card-body">
            <h5 class="card-title">
            <i class="pr-2"><img src="https://img.icons8.com/material-sharp/24/ffffff/video.png"/></i>
            Video Courses</h5>
            <p class="card-text">Lorem ipsum dolor sit amet consectetur adipisicing elit. Aliquam, vero.</p>
            <a href="#" class="btn bg-red text-white">Manage</a>
          </div>
        </div>
      </div>
    </div>
